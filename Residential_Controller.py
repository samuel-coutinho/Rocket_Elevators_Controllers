...
def Scenario2():
    ...
    runScenario(column2, column2.elevatorList[0].currentFloor, column2.elevatorList[0].elevatorDirection, column2.elevatorList[1].currentFloor, column2.elevatorList[1].elevatorDirection, floorOfPersonRequestingElevator, requestedFloor)    

    # 2 minutes later, someone else is on the 3rd floor and requests the 5th floor. Elevator B should be sent
    time.sleep(1)     
    print('2 minutes later, someone else is on the 3rd floor and requests the 5th floor. Elevator B = 1 should be sent.\n')    
    floorOfPersonRequestingElevator = 3
    requestedFloor = 5
    ...
    print('Finally, a third person is at floor 9 and wants to go down to the 2nd floor. Elevator A = 0 should be sent.\n')
